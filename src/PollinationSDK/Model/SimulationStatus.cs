...
namespace PollinationSDK.Model
{
    ...
    public partial class SimulationStatus :  IEquatable<SimulationStatus>, IValidatableObject
    {
        ...
        (
           string status, DateTime startedAt, string id, string accountId, string projectId, string recipeId, string recipeAccountId, string recipePackageId, // Required parameters
