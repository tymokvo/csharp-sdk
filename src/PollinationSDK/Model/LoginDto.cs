...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoginDto : HoneybeeObject, IEquatable<LoginDto>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"LoginDto {iDd.Identifier}";
        ...
        {
            var obj = JsonConvert.DeserializeObject<LoginDto>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
