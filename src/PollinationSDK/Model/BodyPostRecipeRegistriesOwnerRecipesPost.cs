...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract]
    public partial class BodyPostRecipeRegistriesOwnerRecipesPost : HoneybeeObject, IEquatable<BodyPostRecipeRegistriesOwnerRecipesPost>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"BodyPostRecipeRegistriesOwnerRecipesPost {iDd.Identifier}";
        ...
        {
            return Duplicate() as BodyPostRecipeRegistriesOwnerRecipesPost;
        }
