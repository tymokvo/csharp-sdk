...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract]
    public partial class Arguments : HoneybeeObject, IEquatable<Arguments>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"Arguments {iDd.Identifier}";
        ...
        {
            var obj = JsonConvert.DeserializeObject<Arguments>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
