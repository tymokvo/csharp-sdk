...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunctionParameterOut : HoneybeeObject, IEquatable<FunctionParameterOut>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"FunctionParameterOut {iDd.Identifier}";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("FunctionParameterOut:\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionParameterOut>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        {
            return Duplicate() as FunctionParameterOut;
        }
