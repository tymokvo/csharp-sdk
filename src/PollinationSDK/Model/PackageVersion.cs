...
namespace PollinationSDK.Model
{
    ...
    public partial class PackageVersion :  IEquatable<PackageVersion>, IValidatableObject
    {
        ...
        (
           ...
           string appVersion= default, List<string> keywords= default, List<Maintainer> maintainers= default, string home= default, List<string> sources= default, string icon= default, bool deprecated= default, string description= default, string license= default, string slug= default, string type = "", string readme= default, AnyOf<Recipe,Operator> manifest= default// Optional parameters
        )// BaseClass
        {
