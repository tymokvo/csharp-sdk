...
namespace PollinationSDK.Model
{
    ...
    public partial class PackageDto :  IEquatable<PackageDto>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (digest == null)
            {
                throw new InvalidDataException("digest is a required property for PackageDto and cannot be null");
            }
            else
            {
                this.Digest = digest;
            ...
            if (tag == null)
            {
                throw new InvalidDataException("tag is a required property for PackageDto and cannot be null");
            }
            else
            {
                this.Tag = tag;
            ...
            if (manifest == null)
            {
                throw new InvalidDataException("manifest is a required property for PackageDto and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<PackageDto>(json, JsonSetting.ConvertSetting);
            return obj;
        }
