...
namespace PollinationSDK.Api
{
    ...
    public interface IJobsApi : IApiAccessor
    {
        ...
        ApiResponse<StepList> GetJobStepsWithHttpInfo (string owner, string name, string jobId);
        /// <summary>
        ...
        JobList ListJobs (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default);
        ...
        ApiResponse<JobList> ListJobsWithHttpInfo (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default);
        /// <summary>
        /// resume a job
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<StepList> GetJobStepsAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StepList>> GetJobStepsWithHttpInfoAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List artifacts in a job folder
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<JobList> ListJobsAsync (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<JobList>> ListJobsWithHttpInfoAsync (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// resume a job
        /// </summary>
        /// <remarks>
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        /// <param name="jobId"></param>
        /// <returns>StepList</returns>
        public StepList GetJobSteps (string owner, string name, string jobId)
        {
             ApiResponse<StepList> localVarResponse = GetJobStepsWithHttpInfo(owner, name, jobId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobId"></param>
        /// <returns>ApiResponse of StepList</returns>
        public ApiResponse<StepList> GetJobStepsWithHttpInfo (string owner, string name, string jobId)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of StepList</returns>
        public async System.Threading.Tasks.Task<StepList> GetJobStepsAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<StepList> localVarResponse = await GetJobStepsWithHttpInfoAsync(owner, name, jobId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (StepList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StepList>> GetJobStepsWithHttpInfoAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling JobsApi->GetJobSteps");
        ...
        /// <param name="status">The status of the simulation to filter by (optional)</param>
        /// <returns>JobList</returns>
        public JobList ListJobs (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default)
        {
             ApiResponse<JobList> localVarResponse = ListJobsWithHttpInfo(owner, name, page, perPage, id, status);
             return localVarResponse.Data;
        }
        ...
        /// <param name="status">The status of the simulation to filter by (optional)</param>
        /// <returns>ApiResponse of JobList</returns>
        public ApiResponse<JobList> ListJobsWithHttpInfo (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of JobList</returns>
        public async System.Threading.Tasks.Task<JobList> ListJobsAsync (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<JobList> localVarResponse = await ListJobsWithHttpInfoAsync(owner, name, page, perPage, id, status, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (JobList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<JobList>> ListJobsWithHttpInfoAsync (string owner, string name, int? page = default, int? perPage = default, List<string> id = default, List<string> status = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling JobsApi->ListJobs");
