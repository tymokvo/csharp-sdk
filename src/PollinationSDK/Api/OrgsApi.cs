...
namespace PollinationSDK.Api
{
    ...
    public interface IOrgsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<OrgDto> GetOrgAsync (string name);
        ...
        System.Threading.Tasks.Task<ApiResponse<OrgDto>> GetOrgAsyncWithHttpInfo (string name);
        /// <summary>
        /// List an Org&#39;s members
        /// </summary>
        /// <remarks>
        ...
        /// <param name="role"></param>
        /// <returns>Task of UpdateAccepted</returns>
        System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrgRoleEnum role);
        ...
        /// <param name="role"></param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberAsyncWithHttpInfo (string name, string username, OrgRoleEnum role);
    ...
    public partial class OrgsApi : IOrgsApi
    {
        ...
        /// <param name="name"></param>
        /// <returns>Task of OrgDto</returns>
        public async System.Threading.Tasks.Task<OrgDto> GetOrgAsync (string name)
        {
             ApiResponse<OrgDto> localVarResponse = await GetOrgAsyncWithHttpInfo(name);
             return localVarResponse.Data;
        ...
        /// <param name="name"></param>
        /// <returns>Task of ApiResponse (OrgDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrgDto>> GetOrgAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->GetOrg");
        ...
        /// <param name="role"></param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrgRoleEnum role)
        {
        ...
        /// <param name="role"></param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberAsyncWithHttpInfo (string name, string username, OrgRoleEnum role)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->UpsertOrgMember");
