...
namespace PollinationSDK.Api
{
    ...
    public interface IOrgsApi : IApiAccessor
    {
        ...
        OrganizationMemberList GetOrgMembers (string name, int? page = 1, int? perPage = 25);
        ...
        ApiResponse<OrganizationMemberList> GetOrgMembersWithHttpInfo (string name, int? page = 1, int? perPage = 25);
        /// <summary>
        /// List Orgs
        /// </summary>
        /// <remarks>
        ...
        OrganizationList ListOrgs (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default);
        ...
        ApiResponse<OrganizationList> ListOrgsWithHttpInfo (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default);
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CreatedContent> CreateOrgAsync (OrganizationCreate organizationCreate);
        ...
        System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateOrgAsyncWithHttpInfo (OrganizationCreate organizationCreate);
        /// <summary>
        /// Delete an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Organization> GetOrgAsync (string name);
        ...
        System.Threading.Tasks.Task<ApiResponse<Organization>> GetOrgAsyncWithHttpInfo (string name);
        /// <summary>
        /// List organization members
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OrganizationMemberList> GetOrgMembersAsync (string name, int? page = 1, int? perPage = 25);
        ...
        System.Threading.Tasks.Task<ApiResponse<OrganizationMemberList>> GetOrgMembersAsyncWithHttpInfo (string name, int? page = 1, int? perPage = 25);
        /// <summary>
        /// List Orgs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsAsyncWithHttpInfo (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default);
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpdateAccepted> UpdateOrgAsync (string name, OrganizationUpdate organizationUpdate);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpdateOrgAsyncWithHttpInfo (string name, OrganizationUpdate organizationUpdate);
        /// <summary>
        /// Add or update the role of an Org Member
        /// </summary>
        /// <remarks>
        ...
        /// <param name="role"></param>
        /// <returns>Task of UpdateAccepted</returns>
        System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrganizationRoleEnum role);
        ...
        /// <param name="role"></param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberAsyncWithHttpInfo (string name, string username, OrganizationRoleEnum role);
    ...
    public partial class OrgsApi : IOrgsApi
    {
        ...
        /// <param name="organizationCreate"></param>
        /// <returns>Task of CreatedContent</returns>
        public async System.Threading.Tasks.Task<CreatedContent> CreateOrgAsync (OrganizationCreate organizationCreate)
        {
             ApiResponse<CreatedContent> localVarResponse = await CreateOrgAsyncWithHttpInfo(organizationCreate);
             return localVarResponse.Data;
        ...
        /// <param name="organizationCreate"></param>
        /// <returns>Task of ApiResponse (CreatedContent)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateOrgAsyncWithHttpInfo (OrganizationCreate organizationCreate)
        {
            // verify the required parameter 'organizationCreate' is set
            if (organizationCreate == null)
                throw new ApiException(400, "Missing required parameter 'organizationCreate' when calling OrgsApi->CreateOrg");
        ...
        /// <param name="name"></param>
        /// <returns>Task of Organization</returns>
        public async System.Threading.Tasks.Task<Organization> GetOrgAsync (string name)
        {
             ApiResponse<Organization> localVarResponse = await GetOrgAsyncWithHttpInfo(name);
             return localVarResponse.Data;
        ...
        /// <param name="name"></param>
        /// <returns>Task of ApiResponse (Organization)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Organization>> GetOrgAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->GetOrg");
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>OrganizationMemberList</returns>
        public OrganizationMemberList GetOrgMembers (string name, int? page = 1, int? perPage = 25)
        {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of OrganizationMemberList</returns>
        public ApiResponse<OrganizationMemberList> GetOrgMembersWithHttpInfo (string name, int? page = 1, int? perPage = 25)
        {
            // verify the required parameter 'name' is set
            if (name == null)
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>Task of OrganizationMemberList</returns>
        public async System.Threading.Tasks.Task<OrganizationMemberList> GetOrgMembersAsync (string name, int? page = 1, int? perPage = 25)
        {
             ApiResponse<OrganizationMemberList> localVarResponse = await GetOrgMembersAsyncWithHttpInfo(name, page, perPage);
             return localVarResponse.Data;
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>Task of ApiResponse (OrganizationMemberList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrganizationMemberList>> GetOrgMembersAsyncWithHttpInfo (string name, int? page = 1, int? perPage = 25)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->GetOrgMembers");
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>OrganizationList</returns>
        public OrganizationList ListOrgs (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default)
        {
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>ApiResponse of OrganizationList</returns>
        public ApiResponse<OrganizationList> ListOrgsWithHttpInfo (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default)
        {
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>Task of OrganizationList</returns>
        public async System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default)
        {
             ApiResponse<OrganizationList> localVarResponse = await ListOrgsAsyncWithHttpInfo(page, perPage, name, member);
             return localVarResponse.Data;
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>Task of ApiResponse (OrganizationList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsAsyncWithHttpInfo (int? page = 1, int? perPage = 25, List<string> name = default, List<string> member = default)
        {
        ...
        /// <param name="organizationUpdate"></param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpdateOrgAsync (string name, OrganizationUpdate organizationUpdate)
        {
             ApiResponse<UpdateAccepted> localVarResponse = await UpdateOrgAsyncWithHttpInfo(name, organizationUpdate);
             return localVarResponse.Data;
        ...
        /// <param name="organizationUpdate"></param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpdateOrgAsyncWithHttpInfo (string name, OrganizationUpdate organizationUpdate)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->UpdateOrg");
        ...
        /// <param name="role"></param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrganizationRoleEnum role)
        {
        ...
        /// <param name="role"></param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberAsyncWithHttpInfo (string name, string username, OrganizationRoleEnum role)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->UpsertOrgMember");
