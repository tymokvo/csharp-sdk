...
namespace PollinationSDK.Api
{
    ...
    public interface IRegistriesApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task GetPackageAsync (string owner, string type, string name, string digest);
    ...
    public partial class RegistriesApi : IRegistriesApi
    {
        ...
        /// <param name="digest"></param>
        /// <returns></returns>
        public void GetPackage (string owner, string type, string name, string digest)
        {
             GetPackageWithHttpInfo(owner, type, name, digest);
        }
        ...
        /// <param name="digest"></param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetPackageAsync (string owner, string type, string name, string digest)
        {
             await GetPackageAsyncWithHttpInfo(owner, type, name, digest);
