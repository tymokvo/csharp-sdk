...
namespace PollinationSDK.Api
{
    ...
    public interface IAccountsApi : IApiAccessor
    {
        ...
        PublicAccountList ListAccounts (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default);
        ...
        ApiResponse<PublicAccountList> ListAccountsWithHttpInfo (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default);
        ...
        System.Threading.Tasks.Task<PublicAccountList> ListAccountsAsync (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicAccountList>> ListAccountsWithHttpInfoAsync (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <param name="role">The role the user has in relation to this account (optional)</param>
        /// <returns>PublicAccountList</returns>
        public PublicAccountList ListAccounts (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default)
        {
             ApiResponse<PublicAccountList> localVarResponse = ListAccountsWithHttpInfo(page, perPage, search, type, role);
             return localVarResponse.Data;
        }
        ...
        /// <param name="role">The role the user has in relation to this account (optional)</param>
        /// <returns>ApiResponse of PublicAccountList</returns>
        public ApiResponse<PublicAccountList> ListAccountsWithHttpInfo (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PublicAccountList</returns>
        public async System.Threading.Tasks.Task<PublicAccountList> ListAccountsAsync (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PublicAccountList> localVarResponse = await ListAccountsWithHttpInfoAsync(page, perPage, search, type, role, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PublicAccountList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PublicAccountList>> ListAccountsWithHttpInfoAsync (int? page = default, int? perPage = default, string search = default, string type = default, RoleEnum? role = default, CancellationToken cancellationToken = default(CancellationToken))
        {
