...
namespace PollinationSDK.Api
{
    ...
    public interface IPluginsApi : IApiAccessor
    {
        ...
        PluginPackageList ListPluginTags (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default);
        ...
        ApiResponse<PluginPackageList> ListPluginTagsWithHttpInfo (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default);
        /// <summary>
        /// List plugins
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PluginPackageList> ListPluginTagsAsync (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PluginPackageList>> ListPluginTagsWithHttpInfoAsync (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List plugins
        /// </summary>
        /// <remarks>
    ...
    public partial class PluginsApi : IPluginsApi
    {
        ...
        /// <param name="sortOrder">The order to sort the list (optional)</param>
        /// <returns>PluginPackageList</returns>
        public PluginPackageList ListPluginTags (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default)
        {
             ApiResponse<PluginPackageList> localVarResponse = ListPluginTagsWithHttpInfo(owner, name, page, perPage, sortBy, sortOrder);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sortOrder">The order to sort the list (optional)</param>
        /// <returns>ApiResponse of PluginPackageList</returns>
        public ApiResponse<PluginPackageList> ListPluginTagsWithHttpInfo (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PluginPackageList</returns>
        public async System.Threading.Tasks.Task<PluginPackageList> ListPluginTagsAsync (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PluginPackageList> localVarResponse = await ListPluginTagsWithHttpInfoAsync(owner, name, page, perPage, sortBy, sortOrder, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PluginPackageList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PluginPackageList>> ListPluginTagsWithHttpInfoAsync (string owner, string name, int? page = default, int? perPage = default, PackageSortKey? sortBy = default, SortEnum? sortOrder = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling PluginsApi->ListPluginTags");
