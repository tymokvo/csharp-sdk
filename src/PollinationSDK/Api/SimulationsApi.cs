...
namespace PollinationSDK.Api
{
    ...
    public interface ISimulationsApi : IApiAccessor
    {
        ...
        List<FileMeta> ListSimulationArtifacts (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default);
        ...
        ApiResponse<List<FileMeta>> ListSimulationArtifactsWithHttpInfo (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default);
        /// <summary>
        /// List simulations
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CreatedContent> CreateSimulationAsync (string owner, string name, SubmitSimulation submitSimulation, string authorization = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateSimulationAsyncWithHttpInfo (string owner, string name, SubmitSimulation submitSimulation, string authorization = default);
        /// <summary>
        /// Download an artifact from the simulation folder
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<object> DownloadSimulationArtifactAsync (string owner, string name, string simulationId, string path = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<object>> DownloadSimulationArtifactAsyncWithHttpInfo (string owner, string name, string simulationId, string path = default);
        /// <summary>
        /// Get a Simulation
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<FileMeta>> ListSimulationArtifactsAsync (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<FileMeta>>> ListSimulationArtifactsAsyncWithHttpInfo (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default);
        /// <summary>
        /// List simulations
        /// </summary>
        /// <remarks>
    ...
    public partial class SimulationsApi : ISimulationsApi
    {
        ...
        /// <param name="authorization"> (optional)</param>
        /// <returns>Task of CreatedContent</returns>
        public async System.Threading.Tasks.Task<CreatedContent> CreateSimulationAsync (string owner, string name, SubmitSimulation submitSimulation, string authorization = default)
        {
             ApiResponse<CreatedContent> localVarResponse = await CreateSimulationAsyncWithHttpInfo(owner, name, submitSimulation, authorization);
             return localVarResponse.Data;
        ...
        /// <param name="authorization"> (optional)</param>
        /// <returns>Task of ApiResponse (CreatedContent)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateSimulationAsyncWithHttpInfo (string owner, string name, SubmitSimulation submitSimulation, string authorization = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling SimulationsApi->CreateSimulation");
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> DownloadSimulationArtifactAsync (string owner, string name, string simulationId, string path = default)
        {
             ApiResponse<object> localVarResponse = await DownloadSimulationArtifactAsyncWithHttpInfo(owner, name, simulationId, path);
             return localVarResponse.Data;
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> DownloadSimulationArtifactAsyncWithHttpInfo (string owner, string name, string simulationId, string path = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling SimulationsApi->DownloadSimulationArtifact");
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>List&lt;FileMeta&gt;</returns>
        public List<FileMeta> ListSimulationArtifacts (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default)
        {
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>ApiResponse of List&lt;FileMeta&gt;</returns>
        public ApiResponse<List<FileMeta>> ListSimulationArtifactsWithHttpInfo (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>Task of List&lt;FileMeta&gt;</returns>
        public async System.Threading.Tasks.Task<List<FileMeta>> ListSimulationArtifactsAsync (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default)
        {
             ApiResponse<List<FileMeta>> localVarResponse = await ListSimulationArtifactsAsyncWithHttpInfo(owner, name, simulationId, page, perPage, path);
             return localVarResponse.Data;
        ...
        /// <param name="path">The path to an file within a project folder (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;FileMeta&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<FileMeta>>> ListSimulationArtifactsAsyncWithHttpInfo (string owner, string name, string simulationId, int? page = 1, int? perPage = 25, List<string> path = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling SimulationsApi->ListSimulationArtifacts");
