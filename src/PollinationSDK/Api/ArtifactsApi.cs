...
namespace PollinationSDK.Api
{
    ...
    public interface IArtifactsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<S3UploadRequest> CreateArtifactAsync (string owner, string name, KeyRequest keyRequest);
        ...
        System.Threading.Tasks.Task<ApiResponse<S3UploadRequest>> CreateArtifactAsyncWithHttpInfo (string owner, string name, KeyRequest keyRequest);
        /// <summary>
        /// Delete one or many artifacts by key/prefix
        /// </summary>
        /// <remarks>
