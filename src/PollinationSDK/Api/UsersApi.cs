...
namespace PollinationSDK.Api
{
    ...
    public interface IUsersApi : IApiAccessor
    {
        ...
        UserPublicList ListUsers (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default);
        ...
        ApiResponse<UserPublicList> ListUsersWithHttpInfo (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default);
        ...
        System.Threading.Tasks.Task<UserPublic> GetOneUserAsync (string name);
        ...
        System.Threading.Tasks.Task<ApiResponse<UserPublic>> GetOneUserAsyncWithHttpInfo (string name);
        /// <summary>
        /// List Users
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UserPublicList> ListUsersAsync (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<UserPublicList>> ListUsersAsyncWithHttpInfo (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default);
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <param name="name"></param>
        /// <returns>Task of UserPublic</returns>
        public async System.Threading.Tasks.Task<UserPublic> GetOneUserAsync (string name)
        {
             ApiResponse<UserPublic> localVarResponse = await GetOneUserAsyncWithHttpInfo(name);
             return localVarResponse.Data;
        ...
        /// <param name="name"></param>
        /// <returns>Task of ApiResponse (UserPublic)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserPublic>> GetOneUserAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling UsersApi->GetOneUser");
        ...
        /// <param name="id">A list of users to search for by their user ID (optional)</param>
        /// <returns>UserPublicList</returns>
        public UserPublicList ListUsers (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default)
        {
        ...
        /// <param name="id">A list of users to search for by their user ID (optional)</param>
        /// <returns>ApiResponse of UserPublicList</returns>
        public ApiResponse<UserPublicList> ListUsersWithHttpInfo (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default)
        {
        ...
        /// <param name="id">A list of users to search for by their user ID (optional)</param>
        /// <returns>Task of UserPublicList</returns>
        public async System.Threading.Tasks.Task<UserPublicList> ListUsersAsync (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default)
        {
             ApiResponse<UserPublicList> localVarResponse = await ListUsersAsyncWithHttpInfo(page, perPage, name, username, id);
             return localVarResponse.Data;
        ...
        /// <param name="id">A list of users to search for by their user ID (optional)</param>
        /// <returns>Task of ApiResponse (UserPublicList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserPublicList>> ListUsersAsyncWithHttpInfo (int? page = 1, int? perPage = 25, string name = default, string username = default, List<string> id = default)
        {
