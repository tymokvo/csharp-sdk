...
namespace PollinationSDK.Api
{
    ...
    public interface IProjectsApi : IApiAccessor
    {
        ...
        ApiResponse<Object> GetProjectWithHttpInfo (string owner, string name);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Object> GetProjectAsync (string owner, string name);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetProjectAsyncWithHttpInfo (string owner, string name);
        /// <summary>
        /// Get a project&#39;s access permissions
        /// </summary>
        /// <remarks>
    ...
    public partial class ProjectsApi : IProjectsApi
    {
        ...
        /// <param name="name"></param>
        /// <returns>Object</returns>
        public Object GetProject (string owner, string name)
        {
             ApiResponse<Object> localVarResponse = GetProjectWithHttpInfo(owner, name);
             return localVarResponse.Data;
        }
        ...
        /// <param name="name"></param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse<Object> GetProjectWithHttpInfo (string owner, string name)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="name"></param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> GetProjectAsync (string owner, string name)
        {
             ApiResponse<Object> localVarResponse = await GetProjectAsyncWithHttpInfo(owner, name);
             return localVarResponse.Data;
        ...
        /// <param name="name"></param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetProjectAsyncWithHttpInfo (string owner, string name)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ProjectsApi->GetProject");
