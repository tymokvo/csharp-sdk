...
> PluginPackageList ListPluginTags (string owner, string name, int? page = null, int? perPage = null, PackageSortKey? sortBy = null, SortEnum? sortOrder = null)
...
namespace Example
{
    public class ListPluginTagsExample
    {
        public static void Main()
        {
            ...
            {
                // Get a plugin tags
                PluginPackageList result = apiInstance.ListPluginTags(owner, name, page, perPage, sortBy, sortOrder);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
> RepositoryList ListPlugins (int? page = null, int? perPage = null, List<string> search = null, List<string> name = null, List<string> owner = null, bool? _public = null, List<string> keyword = null, List<string> permission = null, RepositorySortKey? sortBy = null, SortEnum? sortOrder = null)
...
namespace Example
{
    public class ListPluginsExample
    {
        public static void Main()
        {
            ...
            {
                // List plugins
                RepositoryList result = apiInstance.ListPlugins(page, perPage, search, name, owner, _public, keyword, permission, sortBy, sortOrder);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
