...
> ProjectList ListProjects (int? page = null, int? perPage = null, string search = null, List<string> ids = null, List<string> names = null, List<string> owner = null, bool? _public = null, List<string> permissions = null, ProjectSortKey? sortBy = null, SortEnum? sortOrder = null)
...
namespace Example
{
    public class ListProjectsExample
    {
        public static void Main()
        {
            ...
            {
                // List Projects
                ProjectList result = apiInstance.ListProjects(page, perPage, search, ids, names, owner, _public, permissions, sortBy, sortOrder);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
