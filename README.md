...
*OperatorsApi* | [**GetOperatorTag**](docs/OperatorsApi.md#getoperatortag) | **GET** /operators/{owner}/{name}/tags/{tag} | Get an operator tag
*OperatorsApi* | [**GetOperatorTags**](docs/OperatorsApi.md#getoperatortags) | **GET** /operators/{owner}/{name}/tags | Get an operator tags
...
*RecipesApi* | [**GetRecipeTag**](docs/RecipesApi.md#getrecipetag) | **GET** /recipes/{owner}/{name}/tags/{tag} | Get a recipe tag
*RecipesApi* | [**GetRecipeTags**](docs/RecipesApi.md#getrecipetags) | **GET** /recipes/{owner}/{name}/tags | Get a recipe tags
